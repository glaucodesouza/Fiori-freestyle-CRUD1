		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CRUDL com Data e Hora",
									"targetURL": "#fiorifreestylecrud1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fiorifreestylecrud1-display": {
								"semanticObject": "fiorifreestylecrud1",
								"action": "display",
								"description": "CRUDL com data e hora",
								"title": "CRUDL com Data e Hora",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fiorifreestylecrud1",
									"url": sap.ui.require.toUrl("fiorifreestylecrud1")
								}
							}
						}
					}
